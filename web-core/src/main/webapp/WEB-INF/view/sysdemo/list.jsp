...
<body>
	...
	<table id="dg" class="easyui-datagrid"  url="<%=contextPath%>/sys/sysdemo/list"
		...
		<thead>
			<tr>
				<th data-options="field:'demo_id',align:'center',hidden:true">demo_id</th>
				<th data-options="field:'demo_name',align:'center',width:100">demo_name</th>
				<th data-options="field:'demo_title',align:'center',width:100">demo_title</th>
				...
				<th data-options="field:'money',align:'center',width:100">money</th>
			</tr>
		</thead>
	</table>
</body>
