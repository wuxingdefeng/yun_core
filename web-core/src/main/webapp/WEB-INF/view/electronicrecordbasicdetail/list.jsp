...
<body>
	...
	<table id="dg" class="easyui-datagrid"  url="<%=contextPath%>/sys/electronicrecordbasicdetail/list"
		...
		<thead>
			<tr>
				<th data-options="field:'detail_id',align:'center',hidden:true">detail_id</th>
				<th data-options="field:'record_id',align:'center',width:100">record_id</th>
				<th data-options="field:'jsondata',align:'center',width:100">jsondata</th>
				<th data-options="field:'htmldata',align:'center',width:100">htmldata</th>
				<th data-options="field:'create_date',align:'center',width:100">create_date</th>
				<th data-options="field:'create_by',align:'center',width:100">create_by</th>
				...
				<th data-options="field:'del_by',align:'center',width:100">del_by</th>
				<th data-options="field:'remarks',align:'center',width:100">remarks</th>
			</tr>
		</thead>
	</table>
</body>
